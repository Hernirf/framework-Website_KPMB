          ...
          <div class="mx-auto mb-4 max-w-[400px] pb-4">
            <form name="wf-form-password" action="{{route('Anggota.store')}}" method="POST">
                ...
                <div class="w-full relative">
                    ...
                    <input type="text" name="ID_anggota" placeholder="ID Anggota..." class="w-full ps-12 pe-4 py-2 bg-slate-50 rounded-sm ring-1 ring-slate-300 focus:outline-none focus:ring-blue-500">
                </div>
